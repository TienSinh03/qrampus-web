...
const AdminResultQRPage = () => {
  ...
  const classSessionId = selectedSchedule?.id || selectedSchedule?.class_session_id || null;
  ...
  }, [classSessionId, initializeAttendanceResults, selectedTeacher?.id]);
  ...
  const courseInfo = useMemo(
    () => ({
      ...
      name: selectedCourse?.name || "Chua co hoc phan",
      type:
        selectedSchedule?.practice_group_name || "Chua phan nhom",
      creator: selectedTeacher?.full_name || "Chua co giang vien",
      creatorID: selectedTeacher?.teacher_code || "N/A",
    }),
    [selectedSchedule, selectedTeacher, selectedCourse]
  );
