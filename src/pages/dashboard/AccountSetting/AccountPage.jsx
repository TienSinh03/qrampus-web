...
import { Upload, X, Settings as SettingsIcon, Eye, EyeOff } from 'lucide-react';
                        ...
                        <div className="flex flex-col md:flex-row items-start space-x-0 md:space-x-8 mb-10">
                            ...
                            <div className="flex-1 space-y-6">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-1">Truy cập lần đầu tiên</label>
                                        <input
                                            type="text"
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            type="text"
                                            defaultValue="12 Nguyễn Văn Bảo, Phường Hạnh Thông, TP.HCM"
                                            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                                        />
                                    </div>
                                </div>
