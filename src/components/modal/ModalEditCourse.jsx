...
const ModalEditCourse = ({ isOpen, onClose, courseData, onSubmit }) => {
  ...
  useEffect(() => {
    if (isOpen && courseData) {
      ...
      setFormData({
        courseCode: courseData.maHocPhan || "",
        courseName: courseData.tenMonHoc || "",
        description: courseData.moTa || "",
        academicYear: courseData.namHoc || "",
        semester: courseData.ky || "",
        maxStudents: courseData.siSo || "",
        learningForm: courseData.hinhThucHoc || "Lý thuyết",
        department: courseData.khoa || "",
        status: courseData.trangThai || "Active",
      });
    }
  }, [isOpen, courseData]);
