...
export const ADMIN_ROUTES = [
  ...
  { path: '/dashboard/admin/qrcode/session/qrcode-detail/sessions', label: 'Chi tiết buổi học' },
  { path: '/dashboard/admin/qrcode/session/qrcode-detail/sessions/detail', label: 'Chi tiết phiên' },
